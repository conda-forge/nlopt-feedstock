...
then
  ...
  CROSS_ARGS="-DPYTHON_EXTENSION_MODULE_SUFFIX=${mod_ext} -DPYTHON_EXECUTABLE=${BUILD_PREFIX}/bin/python -DPYTHON_LIBRARY=${BUILD_PREFIX}/lib/libpython${CONDA_PY:0:1}.${CONDA_PY:1}${SHLIB_EXT} -DPYTHON_INCLUDE_DIR=${BUILD_PREFIX}/include/python${CONDA_PY:0:1}.${CONDA_PY:1}"
fi
